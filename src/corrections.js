...
// المحطات المصحّحة: إعادة بناء مصفوفة الطرق + اعتماد المركز الصحيح ومسافته الفعلية
const FIXES = {
  '915': {
    rebuildRoads: true,                                   // مصفوفتها كانت خاطئة (منسوخة من رياض)
    bench: 'أرامكو شمال جدة', benchKm: 390,                // المعتمد من أرامكو + مسافة الطريق الفعلية المقاسة (389.7كم)
  },
};
